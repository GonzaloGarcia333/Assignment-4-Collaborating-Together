...
author: |
  | Gonzalo Garcia
  | g.garciatakis@students.uu.nl
  | http://www.github.com/GonzaloGarcia333
date: April 2023
urlcolor: purple
linkcolor: purple
output: 
...
The mean growth rate for countries with 0 revolutions (0 Revolutions) is higher (2.46) compared to countries with more than 0 revolutions (More than 0 Revolutions) which has a mean growth rate of 1.68. Similarly, the median growth rate for countries with 0 revolutions is higher (2.29) compared to countries with more than 0 revolutions which has a median growth rate of 1.92. This suggests that, on average, countries with 0 revolutions tend to have higher growth rates than countries with more than 0 revolutions.
...
```{r}
group_0 <- GrowthSW$growth[GrowthSW$treat == "0 Revolutions"]
group_more_than_0 <- GrowthSW$growth[GrowthSW$treat == "More than 0 Revolutions"]
...
#The p-value of the test was p-value = 0.06871, which indicates, with a t = 1.8531, df = 61.015, true difference in means is not equal to 0. The p-value is greater than s.f of 0.05, we cannot conclude that the means of the two groups are significantly different.
...
#The rgdp60 represents the value of GDP per capita in 1960, converted to 1960 US dollars. It is a standardized measure of a countries wealth, and is included in the data set to show the growth of countries under different political, social and economical landscapes. 
...
#According to this analysis, the min driver of economic growth is the variable tradeshare, which has a positive correlation coeficient of 2.233, suggesting that a higher level of the variable trade share is positively associated with higher economic growth. 
